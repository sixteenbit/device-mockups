...
# main config
PLUGINSLUG="device-mockups"
CURRENTDIR=`pwd`
MAINFILE="device-mockups.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/device-mockups/" # Remote SVN repo on wordpress.org, with no trailing slash
SVNUSER="mrdink" # your svn username
